...
$(document).ready(function() {
    ...
    createTable($("#top5ErrorsBySamplerTable"), {"supportsControllersDiscrimination": false, "overall": {"data": ["Total", 2000, 0, "", "", "", "", "", "", "", "", "", ""], "isController": false}, "titles": ["Echantillon", "#Echantillons", "#Erreurs", "Erreur", "#Erreurs", "Erreur", "#Erreurs", "Erreur", "#Erreurs", "Erreur", "#Erreurs", "Erreur", "#Erreurs"], "items": [{"data": [], "isController": false}]}, function(index, item){
        return item;
    }, [[0, 0]], 0);
